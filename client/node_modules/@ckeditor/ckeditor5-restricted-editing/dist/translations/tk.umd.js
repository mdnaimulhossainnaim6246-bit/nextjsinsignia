...
( e => {
const { [ 'tk' ]: { dictionary, getPluralForm } } = {"tk":{"dictionary":{"Enable editing":"Redaktirlemegi işjeňleşdiriň","Previous editable region":"Öňki redaktirläp bolýan sebit","Next editable region":"Indiki redaktirläp bolýan sebit","Navigate editable regions":"Düzedip bolýan sebitlere geçiň","Disable inline editing":"","Enable inline editing":"","Disable block editing":"","Enable block editing":"","Disable editing":""},getPluralForm(n){return (n != 1);}}};
