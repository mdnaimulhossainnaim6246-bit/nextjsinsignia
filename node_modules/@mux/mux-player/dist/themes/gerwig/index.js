...
`;
  ...
  render_fn2 = function() {
    var _a3;
    const hasListChanged = __privateGet8(this, _prevState2) !== JSON.stringify(this.mediaSubtitlesList);
  ...
  render_fn3 = function() {
    ...
    const ratesSet = new Set(Array.from(__privateGet11(this, _rates2)).map((rate) => Number(rate)));
